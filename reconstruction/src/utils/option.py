...
parser.add_argument("--freeze_discriminator", action="store_true", help="Freeze the entire discriminator during training") # <
...
parser.add_argument("--save_every", type=int, default=2000, help="frequency for saving models") # <
